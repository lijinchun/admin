package com.bluesky.admin.api.common.utils;
...
public class DateUtil {
    ...
    public static void clearSimpleDateFormatCache(){
        THREAD_LOCAL.remove();
    }
    ...
    private static Date getAccurateDate(List<Long> timestamps) {
        ...
        long timestamp = 0;
        int initSize = 8;
        Map<Long, Long[]> map = new HashMap<>(initSize);
        List<Long> absoluteValues = new ArrayList<>();
        if (timestamps != null && !timestamps.isEmpty()) {
            if (timestamps.size() > 1) {
                timestamp = getTimestamp(timestamps, timestamp, map, absoluteValues);
            } else {
    ...
    private static long getTimestamp(List<Long> timestamps, long timestamp, Map<Long, Long[]> map, List<Long> absoluteValues) {
    ...
    public static DateStyle getDateStyle(String date) {
        ...
        int initSize = 8;
        Map<Long, DateStyle> map = new HashMap<>(initSize);
     ...
     * @return String
     */
    public static String getAge(Date otherDate) {
